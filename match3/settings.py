...
from src.frames_utility import generate_power_tile_frames
...
input_handler.InputHandler.set_mouse_motion_action(input_handler.MOUSE_MOTION_LEFT, "motion_left")
input_handler.InputHandler.set_mouse_motion_action(input_handler.MOUSE_MOTION_RIGHT, "motion_right")
input_handler.InputHandler.set_mouse_motion_action(input_handler.MOUSE_MOTION_DOWN, "motion_down")
input_handler.InputHandler.set_mouse_motion_action(input_handler.MOUSE_MOTION_UP, "motion_up")
...
TEXTURES = {
    ...
    "power_tiles": pygame.image.load(BASE_DIR / "graphics" / "Power_Up_Cross.png"),
    "power_color_tiles": pygame.image.load(BASE_DIR / "graphics" / "Power_Up_Colors.png"),
}

FRAMES = {"tiles": generate_tile_frames(TEXTURES["tiles"]),
          "power_tiles": generate_power_tile_frames(TEXTURES["power_tiles"])
          }
