...
TEXTURES = {
    ...
    "cannon_fire": pygame.image.load(BASE_DIR / "graphics" / "cannons_fire.png"),
    "cannon": pygame.image.load(BASE_DIR / "graphics" / "cannon.png"),
}
...
FRAMES = {
    ...
    "cannons_fire": generate_cannons_fire_frames(),
}
